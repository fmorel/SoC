...
volatile int new_tile=0;

void new_tile_handler() {
//    my_printf("INTERRUPT\r\n");
    new_tile=1;
}
...
//	    my_printf("New tile == %d\r\n",new_tile);
	...
	*((volatile unsigned int*) 0xB0000000) = 0;
	*((volatile unsigned int*) 0xB0000004) = 0;
	*((volatile unsigned int*) 0xB0000008) = 0;
	*((volatile unsigned int*) 0xB000000C) = X >> 1;
	*((volatile unsigned int*) 0xB0000010) = 0;
	*((volatile unsigned int*) 0xB0000014) = 0;
	*((volatile unsigned int*) 0xB0000018) = 0;
	*((volatile unsigned int*) 0xB000001C) = 0;
	*((volatile unsigned int*) 0xB0000020) = 0;
	*((volatile unsigned int*) 0xB0000024) = 0;
	*((volatile unsigned int*) 0xB0000028) = 0;
	*((volatile unsigned int*) 0xB000002C) = 0;


	*((volatile unsigned int*) 0xB0000000) = 0;
	*((volatile unsigned int*) 0xB0000004) = 0;
	*((volatile unsigned int*) 0xB0000008) = 0;
	*((volatile unsigned int*) 0xB000000C) = Y >> 1;
	*((volatile unsigned int*) 0xB0000010) = 0;
	*((volatile unsigned int*) 0xB0000014) = 0;
	*((volatile unsigned int*) 0xB0000018) = 0;
	*((volatile unsigned int*) 0xB000001C) = 0;
	...
	*((volatile unsigned int*) 0xB0000028) = 0;
	*((volatile unsigned int*) 0xB000002C) = 0;
//	my_printf("Fin de boucle\r\n");
    }
    time[9]=get_cc();

    my_printf("AVERAGE TIME : %d\r\n", (time[9]-time[10])/10);
    // for(i=0;i<10;i++)
    //	my_printf("TIME : %d\r\n", (time[i]-time[i+1]));
    //    }
    return 0;

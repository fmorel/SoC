...
#define INCREMENT_BASE	0xB0000000
#define INCREMENT_SIZE  0x00000100 
#define BUFFER_BASE     0xB1000000
#define BUFFER_SIZE     0x00000100
#define OUTPUT_BASE     0xB2000000
#define OUTPUT_SIZE     0x00000100

#define VIDEO_OUT_BASE	0xB3000000
#define VIDEO_OUT_SIZE  0x00000100
#define VIDEO_IN_BASE   0XB4000000
#define VIDEO_IN_SIZE   0X00000100

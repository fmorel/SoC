...
int _main(int argc, char *argv[])
{
    ...
    maptab.add(Segment("calcul_inc"  , CAL_BASE  , CAL_SIZE  , IntTab(3), false));
    // Gloabal signals
    ...
    soclib::caba::WbSignal<wb_param> signal_wb_calcul_inc("signal_wb_calcul_inc");
    ...
    // Module de calcul incremental
    soclib::caba::CalculInc<wb_param> calcul_inc ("WB_calcul_incremental");
    calcul_inc.p_clk              (signal_clk);
    calcul_inc.p_resetn           (signal_resetn);
    calcul_inc.p_wb               (signal_wb_calcul_inc);
    ...
    wbinterco.p_to_slave[3](signal_wb_calcul_inc);
